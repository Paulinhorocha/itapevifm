...
5. Configurar `SUPABASE_URL` e `SUPABASE_SERVICE_ROLE_KEY` como variáveis de ambiente na Vercel (`CONFIGURAR_USUARIOS.md`, Passo 5) — sem isso, criar/remover/promover usuários não funciona.
